...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func signInNow(_ sender: UIButton) {
        
        /*AF.request("http://polls.apiblueprint.org/home").response {
            response in
            
            //print ---- the link above does not work,
            
            
        }*/
        
        homeCateArray.removeAllObjects()
        
        homeCateArray.add(["imageUrl": "https://img.icons8.com/bubbles/2x/t-shirt.png", "id": 21, "name": "Baju"] as NSDictionary)
        homeCateArray.add(["imageUrl": "https://img.icons8.com/flat_round/2x/long-shorts.png", "id": 42, "name": "Celana"] as NSDictionary)
        homeCateArray.add(["imageUrl": "https://img.icons8.com/flat_round/2x/summer-hat.png", "id": 11, "name": "Topi"] as NSDictionary)
        homeCateArray.add(["imageUrl": "https://img.icons8.com/color/2x/red-purse.png", "id": 91, "name": "Tas"] as NSDictionary)
        homeCateArray.add(["imageUrl": "https://img.icons8.com/cute-clipart/2x/apple-watch-apps.png", "id": 131, "name": "Jam Tangan"])
        
        homeTBArray.removeAllObjects()
        
        homeTBArray.add(["id": "6723",
        ...
        "price": "$340",
        "loved": 0] as NSDictionary)
        homeTBArray.add(["id": "6724",
        ...
        "price": "$70",
        "loved": 1] as NSDictionary)
        homeTBArray.add(["id": "6725",
        ...
        self.performSegue(withIdentifier: "login_done", sender: self)
